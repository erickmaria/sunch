...
interface SettingsProps {
  ...
  onClearHistory?: Array<Dispatch<SetStateAction<unknown>>>
}
          ...
          <div className="theme-switcher-control">
            <div id="theme-switcher-radio" className="switch-field switch-orientation-horizontal switch-theme-xsmall">
              ...
              <input type="radio" id="theme-switcher-radio-radio-light" name="theme-switcher-radio-switch" value="light" 
                defaultChecked={ getCurrentTheme() === 'light' }
              />
              <label onClick={() => {
                changeThemeTo('light')
              }}
              htmlFor="theme-switcher-radio-radio-light" aria-label="Light theme">
              ...
              <label onClick={() => {
                changeThemeTo('dark')
              }} htmlFor="theme-switcher-radio-radio-dark" aria-label="Dark theme">
                <div className="theme-switcher-icon">
                  <Moon size={15} />
                </div>
              </label>
              ...
              <input type="radio" id="theme-switcher-radio-radio-auto" name="theme-switcher-radio-switch" value="auto" 
                defaultChecked={ getCurrentTheme() === 'auto' }
              />
              <label onClick={() => {
                changeThemeTo('auto')
              }} htmlFor="theme-switcher-radio-radio-auto" aria-label="System theme">
                <div className="theme-switcher-icon">
                  <Computer size={15} />
                </div>
              </label>
